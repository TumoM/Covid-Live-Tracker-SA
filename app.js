...
const job2 = new CronJob('0***REMOVED***/10 12-23***REMOVED******REMOVED******REMOVED***', async function () {
    const d = moment();
    const daddy24 = this;
...
const mainJob = new CronJob('0***REMOVED***/30 18-23***REMOVED******REMOVED******REMOVED***', (() => {
    const d2 = moment();

    const job1 = new CronJob('0***REMOVED***/10 19-23***REMOVED******REMOVED******REMOVED***', async function () {
        const d = moment();
        const daddy = this;
