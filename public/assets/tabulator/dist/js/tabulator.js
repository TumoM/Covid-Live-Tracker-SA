...
***REMOVED***)(this, function () {
	...
	***REMOVED***;
	...
	Ajax.prototype.nextPage = function (diff) {
		...
		if (!this.loading) {
			...
			if (diff < margin) {
				this.table.modules.page.nextPage().then(function () {***REMOVED***).catch(function () {***REMOVED***);
			***REMOVED***
		***REMOVED***
	***REMOVED***;
	...
	***REMOVED***;
	...
	Ajax.prototype.generateParamsList = function (data, prefix) {
		...
		if (Array.isArray(data)) {
			...
			***REMOVED***);
		***REMOVED*** else if ((typeof data === 'undefined' ? 'undefined' : _typeof(data)) === "object") {
			for (var key in data) {
	...
	***REMOVED***;
	...
	Ajax.prototype.showLoader = function () {
		...
		if (shouldLoad) {
			...
			***REMOVED***this.msgElement.classList.remove("tabulator-error");
	...
	***REMOVED***;
	...
	Ajax.prototype.showError = function () {
		...
		while (this.msgElement.firstChild) {
			this.msgElement.removeChild(this.msgElement.firstChild);
		***REMOVED***this.msgElement.classList.remove("tabulator-loading");
	...
	DataTree.prototype.generateChildren = function (row) {
		...
		***REMOVED***
		...
		childArray.forEach(function (childData) {
			var childRow = new Row(childData || {***REMOVED***, _this40.table.rowManager);
	...
	***REMOVED***;
	...
	Edit.prototype.clearEditor = function () {
		...
		if (cell) {
			...
			***REMOVED***cell.row.getElement().classList.remove("tabulator-row-editing");
		***REMOVED***
	***REMOVED***;
	...
	***REMOVED***;
	...
	Edit.prototype.edit = function (cell, e, forceEdit) {
		var self = this,
		    allowEdit = true,
		    rendered = function rendered() {***REMOVED***,
		    element = cell.getElement(),
		    cellEditor,
		    component,
		    params;
				...
				***REMOVED***
				...
				if (cellEditor !== false) {
					...
					if (cellEditor instanceof Node) {
						...
						while (element.firstChild) {
							element.removeChild(element.firstChild);
						***REMOVED***element.appendChild(cellEditor);
		...
		select: function select(cell, onRendered, success, cancel, editorParams) {
			...
			***REMOVED***
			...
			function fillList() {
				...
				***REMOVED***displayItems.forEach(function (item) {
					var el = item.element;
			...
			***REMOVED***
			...
			function showList() {
				if (!listEl.parentNode) {
					while (listEl.firstChild) {
						listEl.removeChild(listEl.firstChild);
					***REMOVED***var offset = Tabulator.prototype.helpers.elOffset(cellEl);
	...
	***REMOVED***;
	...
	Group.prototype.getRowIndex = function (row) {***REMOVED***;
	...
	***REMOVED***;
	...
	Group.prototype.generateGroupHeaderContents = function () {
		...
		***REMOVED***);
		...
		while (this.element.firstChild) {
			this.element.removeChild(this.element.firstChild);
		***REMOVED***if (typeof this.elementContents === "string") {
	...
	***REMOVED***;
	...
	Group.prototype.reinitializeHeight = function () {***REMOVED***;
	Group.prototype.calcHeight = function () {***REMOVED***;
	Group.prototype.setCellHeight = function () {***REMOVED***;
	Group.prototype.clearCellHeight = function () {***REMOVED***;
	...
	***REMOVED***;
	...
	var GroupRows = function GroupRows(table) {
		...
		this.startOpen = [function () {
			return false;
		***REMOVED***]; //starting state of group
	...
	***REMOVED***;
	...
	Page.prototype.generatePageSizeSelectList = function () {
		...
		if (this.pageSizeSelect) {
			...
			***REMOVED***pageSizes.forEach(function (item) {
	...
	Page.prototype.initialize = function (hidden) {
		...
		***REMOVED***);
		...
		self.nextBut.addEventListener("click", function () {
			self.nextPage().then(function () {***REMOVED***).catch(function () {***REMOVED***);
		***REMOVED***);
		...
		if (this.pageSizeSelect) {
			...
			***REMOVED***);
			...
			self.pageSizeSelect.addEventListener("change", function (e) {
				...
				self.setPage(1).then(function () {***REMOVED***).catch(function () {***REMOVED***);
			***REMOVED***);
		***REMOVED***
