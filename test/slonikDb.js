...
***REMOVED***
    ...
    connection = process.env.AWS_CONNECTIONSTRING || `host=${process.env.AWS_HOST***REMOVED*** user=${process.env.AWS_USER***REMOVED*** password=${process.env.AWS_PASSWORD***REMOVED*** port=5432 dbname=${process.env.AWS_DB***REMOVED*** ` || {
